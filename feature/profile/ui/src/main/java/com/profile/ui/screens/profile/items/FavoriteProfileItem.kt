...
@Composable
fun FavoriteProfileItem(context:Context,modifier: Modifier = Modifier,onNavigate:()->Unit) {
    Column(
...
@Composable
fun FavoriteProfileItemPreview() {
    PetAdoptionTheme {
       // FavoriteProfileItem(LocalContext.current)
    }
}